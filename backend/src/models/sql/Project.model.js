...
const Project = sequelize.define('Project', {
  ...
  startup_id:     { type: DataTypes.UUID, defaultValue: null },
  ...
  getterMethods: {
    tech_stack() { try { return JSON.parse(this.tech_stack_json||'[]'); } catch { return []; } },
    tags()       { try { return JSON.parse(this.tags_json||'[]'); } catch { return []; } }
  },
  setterMethods: {
    tech_stack(v) { this.setDataValue('tech_stack_json', JSON.stringify(v||[])); },
